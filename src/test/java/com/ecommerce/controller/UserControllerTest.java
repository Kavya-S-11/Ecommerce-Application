...
class UserControllerTest {
    ...
    void registerUser_validBody_returns201() throws Exception {
        ...
        // password must be provided explicitly — @JsonProperty(WRITE_ONLY) excludes it from serialization
        String body = "{\"name\":\"Alice Johnson\",\"email\":\"alice@example.com\",\"password\":\"pass123\",\"address\":\"123 Main St\"}";
